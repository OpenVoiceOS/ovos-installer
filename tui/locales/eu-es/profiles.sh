#!/usr/bin/env bash
CONTENT="
Aplikazio askotarako egokia den sistema polifazetikoa sortzeko, hiru aukera interesgarri daude:
...
Mesedez, hautatu profil bat:
"
TITLE="Ireki Voice OS Instalazioa - Profilak"
