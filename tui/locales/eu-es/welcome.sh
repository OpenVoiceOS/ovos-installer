#!/usr/bin/env bash
CONTENT="
Kaixo eta ongi etorri Open Voice OS instalaziora!
...
Hasi gaur instalazioarekin eta utzi zure ahotsak gidatzen zaituen teknologiaren etorkizunean!🌟
"
TITLE="Ireki Voice OS instalazioa - Ongi etorri"
