#!/usr/bin/env bash
CONTENT="
Erabilera-neurriak partekatzea aukeratuz gero, funtsezko ekarpena egiten diezu gure softwarearen errendimendua eta erabiltzaile-esperientzia etengabe hobetzeko ahaleginei. Ematen dituzun datuak anonimoak izango dira, eta ezinbestekoak dira asmoen identifikazioa fintzeko, sistemaren ahulguneak identifikatzeko eta etorkizuneko garapenei buruzko erabaki informatuak hartzeko.
...
Onartzen al duzu datu anonimoak gurekin partekatzea?
"
TITLE="Ireki Voice OS instalazioa - Erabilera-neurriak"
