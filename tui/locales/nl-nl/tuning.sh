...
CONTENT="
OpenVoice OS Tuning for Raspberry Pi optimaliseert het besturingssysteem zodat het efficiënt draait op de Raspberry Pi hardware.
...
"
TITLE="OpenVoice OS Installatie - Tuning"
