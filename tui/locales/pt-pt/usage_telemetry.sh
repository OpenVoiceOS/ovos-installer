#!/usr/bin/env bash
CONTENT="
Ao optar por partilhar as suas métricas de utilização, torna-se um colaborador essencial nos nossos esforços contínuos para melhorar o desempenho e a experiência de utilização do nosso software. Os dados que fornecer permanecerão anónimos e são fundamentais para nos ajudar a aperfeiçoar a correspondência de intenções, identificar pontos fracos do sistema e tomar decisões informadas sobre desenvolvimentos futuros.
...
Aceita partilhar dados anónimos connosco?
"
TITLE="Instalação do Open Voice OS - Métricas de utilização"
