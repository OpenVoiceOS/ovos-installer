...
इससे OVOS AI सहायक का उपयोग कर सकता है, जब सामान्य skills के पास अच्छा जवाब न हो।

आपसे यह जानकारी मांगी जाएगी:
  - API URL: OVOS AI अनुरोध कहाँ भेजता है
  - API key: उस सेवा के लिए आपकी निजी access key
...
उन्नत विकल्पों के लिए सुरक्षित default मान पहले से भरे हुए हैं।
"
...
LLM_CONTENT_URL="
कृपया अपने provider का OpenAI-संगत API URL दर्ज करें।

उदाहरण: https://llama.smartgic.io/v1

सुझाव: कई compatible server को /v1 हिस्सा चाहिए होता है।
"
LLM_TITLE_KEY="Open Voice OS Installation - LLM API Key"
LLM_CONTENT_KEY="
कृपया अपने AI provider की API key दर्ज करें।

यह निजी रखी जाती है और installer summary में नहीं दिखाई जाती।
"
...
डिफ़ॉल्ट विकल्प छोटे और voice-friendly जवाबों के लिए सेट है।
...
कृपया API URL, API key, मॉडल, सहायक शैली और tuning मान प्रदान करें।
"
