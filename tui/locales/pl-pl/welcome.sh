#!/usr/bin/env bash
CONTENT="
Witaj i zapraszamy do instalacji Open Voice OS!
...
Rozpocznij instalację już dziś i pozwól, aby Twój głos poprowadził Cię przez przyszłość technologii!🌟
"
TITLE="Instalacja Open Voice OS - Witamy"
